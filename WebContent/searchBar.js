...
function handleLookup(query, doneCallback) {
	...
	jQuery.ajax({
		...
		"url": "HeroSuggestion?query=" + escape(query),
	...
	{
		console.log("Suggestion incomplete");
	}
}
...
function handleSelectSuggestion(suggestion) {
	...
	var url = "singleMovie.html" + "?id=" + suggestion["movieId"];
...
function handleNormalSearch(query) {
	...
	window.location.href = "searchBarThis?title=" + query;
}
